...
public:
    ...
    bool WriteZXOSSeed(const uint256& hashSeed, const std::vector<unsigned char>& seed);
    bool ReadZXOSSeed(const uint256& hashSeed, std::vector<unsigned char>& seed);
    bool ReadZXOSSeed_deprecated(uint256& seed);
    bool EraseZXOSSeed();
    bool EraseZXOSSeed_deprecated();

    bool WriteZXOSCount(const uint32_t& nCount);
    bool ReadZXOSCount(uint32_t& nCount);
