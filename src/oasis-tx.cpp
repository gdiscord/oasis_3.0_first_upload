...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || mapArgs.count("-?") || mapArgs.count("-help")) {
        ...
        std::string strUsage = _("OASIS Core oasis-tx utility version") + " " + FormatFullVersionWithCodename() + "\n\n" +
                               _("Usage:") + "\n" +
                               "  oasis-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded oasis transaction") + "\n" +
                               "  oasis-tx [options] -create [commands]   " + _("Create hex-encoded oasis transaction") + "\n" +
                               "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded oasis transaction
