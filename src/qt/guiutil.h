...
/** Utility functions used by the OASIS Qt UI.
 */
namespace GUIUtil
{
...
// Render OASIS addresses in monospace font
...
// Parse "oasis:" URI into recipient object, return true on successful parsing
