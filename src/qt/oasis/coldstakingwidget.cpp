...
#include "qt/oasis/coldstakingwidget.h"
#include "qt/oasis/forms/ui_coldstakingwidget.h"
...
ColdStakingWidget::ColdStakingWidget(OASISGUI* parent) :
    PWidget(parent),
