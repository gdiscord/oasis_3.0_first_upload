    ...
    walletModel(model)
{
    ...
    ui->lineEditPort->setPlaceholderText("e.g 3358");
    ...
    if (walletModel->isRegTestNetwork()) {
        ...
        ui->lineEditPort->setText("53474");
    } else {
        ui->lineEditPort->setText("3358");
    }
...
bool MasterNodeWizardDialog::createMN()
{
    ...
    if (!walletModel->getMNCollateralCandidate(collateralOut)) {
        ...
        SendCoinsRecipient sendCoinsRecipient(QString::fromStdString(address.ToString()), QString::fromStdString(alias), CAmount(285) * COIN, "");
