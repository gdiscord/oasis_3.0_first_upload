...
"""Verify that starting oasis with -h works as expected."""
import subprocess

from test_framework.test_framework import OasisTestFramework
from test_framework.util import assert_equal

class HelpTest(OasisTestFramework):
    ...
    def run_test(self):
        self.log.info("Start oasis with -h for help text")
        ...
        self.log.info("Start oasis with -version for version information")
