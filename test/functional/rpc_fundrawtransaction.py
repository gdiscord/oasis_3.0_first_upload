...
class RawTransactionsTest(OasisTestFramework):
    ...
    def run_test(self):
        ...
        try:
            ...
            raise AssertionError("Accepted invalid oasis address")
        except JSONRPCException as e:
            assert("changeAddress must be a valid oasis address" in e.error['message'])
